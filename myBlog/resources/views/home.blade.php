...
<div class="w-full text-center py-32">
    <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
        Welcome to <span class="text-yellow-500">&lt;MyBlog&gt;</span> <span class="text-gray-900"> News</span>
    </h1>
        ...
        <div class="w-full">
            <div class="grid md:grid-cols-3 gap-10 w-full">
                ...
                @foreach ($featuredPosts as $post)
                    <div class="px-4 py-4 md:col-span-1 col-span-3">
                        <x-posts.post-card :post="$post" />
                    </div>
                @endforeach
            </div>
        </div>
        <a class="mt-10 block text-center text-lg text-yellow-500 font-semibold py-4"
